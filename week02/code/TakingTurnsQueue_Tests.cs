...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Queue returned people in incorrect order; FIFO (first-in-first-out) logic was broken.
    ...
    // Defect(s) Found: Queue returned people in incorrect order after adding a new person; FIFO logic broken.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Queue returned people in incorrect order; the person with infinite turns did not stay correctly at the front.
    ...
    // Defect(s) Found: Queue returned people in the wrong order; negative (infinity) turns did not preserve the FIFO order.
    ...
    // Defect(s) Found: None; exception is correctly cast when the tail is empty.
